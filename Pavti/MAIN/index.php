        ...
        if ($user) {
            ...
            if (password_verify($password, $user['password'])) {
                ...
                if ($currentDate > $expiryDate) {
                    $error = "<div class='alert alert-danger'>Your subscription has expired. Please contact your service provider to renew it.</div>";
                } else {
                    ...
                    if ($user['role'] == 'user') {
                        header("Location: client_dashboard.php");  // Redirect to client form
                        exit();
                    }
                }
            } else {
